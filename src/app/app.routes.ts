...
import { QuantumEncryptionComponent } from './components/quantum-encryption/quantum-encryption.component';
...
export const routes: Routes = [
    ...
    { path: 'postquantum', component: QuantumEncryptionComponent },
